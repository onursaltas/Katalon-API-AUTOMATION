...
response = WS.sendRequestAndVerify(findTestObject('Admin/GET User', [('url') : GlobalVariable.url, ('token') : GlobalVariable.token]))
...
//WS.verifyElementPropertyValue(response, 'data[2].employeeId', "5")