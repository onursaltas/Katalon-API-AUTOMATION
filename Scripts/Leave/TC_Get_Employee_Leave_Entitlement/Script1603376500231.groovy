...
response = WS.sendRequestAndVerify(findTestObject('Leave/GET_Employee_Leave_Entitlement', [('url') : GlobalVariable.url, ('token') : GlobalVariable.token]))
...
WS.verifyElementPropertyValue(response, 'data[0].days', 1)